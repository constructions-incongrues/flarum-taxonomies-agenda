...
[![CI](https://github.com/constructions-incongrues/mi-agenda-timeline/actions/workflows/ci.yml/badge.svg)](https://github.com/constructions-incongrues/mi-agenda-timeline/actions/workflows/ci.yml)
...
```bash
composer config repositories.mi-agenda-timeline vcs https://github.com/constructions-incongrues/mi-agenda-timeline
composer require mi/agenda-timeline:dev-main
php flarum migrate
...
```bash
composer require mi/agenda-timeline:^0.1
```
